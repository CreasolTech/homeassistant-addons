...
python3 dombusgateway.py --data_dir "${DATA_DIR}" --debug_level "${DEBUG_LEVEL}" --bus1_port "${BUS1_PORT}" --bus2_port "${BUS2_PORT}" --bus3_port "${BUS3_PORT}" --bus4_port "${BUS4_PORT}" --mqtt_host "${MQTT_HOST}" --mqtt_port "${MQTT_PORT}" --mqtt_user "${MQTT_USER}" --mqtt_pass "${MQTT_PASS}"
